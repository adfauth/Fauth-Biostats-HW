...
The kip tract has larger median SOM among the other forests and the other three have very similar medians, but Donnerville has a clear outlier. The other three forests have very narrow spread compared to the Kip Tract which had a large spread and is skewed right.

-   What do you notice that is different from how the data were displayed in the bar plot?
The Donnerville center (this time the average) seems much larger in comparison and the spread is much larger as well. The bar graph makes the Donnerville data seem more similar to the Kip Tract distribution than the box plots do.
